package br.com.desafioandroid.desafioandroid.adapter;
...
import br.com.desafioandroid.desafioandroid.view.DetalhesPersonagemActivity;
...
public class PersonagemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        String resultDescricao = resultList.get(position).getDescription();
        String resultThumbnail = resultList.get(position).getThumbnail().getPath()
                + "." + resultList.get(position).getThumbnail().getExtension();

        Personagem personagem = new Personagem(resultId, resultName, resultDescricao, resultThumbnail);

        switch (getItemViewType(position)){
            case ITEM:

                if (result.getId() != null && result.getName() != null && result.getDescription() != null && result.getThumbnail() != null ){
                    ...
                    /// publicationVH.txt_descricao_personagem.setText(personagem.getDescricao());
    ...
    protected class PublicationVH extends RecyclerView.ViewHolder {
        ...
        TextView txt_descricao_personagem;
        ...
        public PublicationVH(View view) {
            ...
            txt_descricao_personagem = itemView.findViewById(R.id.card_txt_descricao_personagem);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (resultList.get(position).getId() == txt_id_personagem.getText().toString()){
                        ...
                        resultDescricao = resultList.get(position).getDescription();
                        Intent goDetails = new Intent(activity,DetalhesPersonagemActivity.class);
                        ...
                        goDetails.putExtra("descricao", resultDescricao);
