...
public class ComicsAdapter extends RecyclerView.Adapter<ComicsAdapter.ComicsViewHolder> {
    ...
    private ArrayList<Revista> comicsList;
    private SharedPreferences sharedPreferences;
    private String id;

    public ComicsAdapter(Activity activity, ArrayList<Revista> comicsList) {
...
//        id = sharedPreferences.getString("personagem_id",null);
    ...
    public void onBindViewHolder(ComicsViewHolder holder, int position) {
        ...
        String nome = comicsList.get(position).getNome();

       // holder.itemView.txt_nome_revista.Text();
       /// holder.txt_nome_revista.setTag(nome);

        String comics = comicsList.get(position).getUrl();
...
//        TextView txt_url;
        ...
        public ComicsViewHolder(View itemView) {
           ...
           /// txt_nome_revista = itemView.findViewById(R.id.card_txt_nome_revista);
